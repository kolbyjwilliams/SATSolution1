...
namespace SATUI.MVC.Controllers
{
    public class ScheduledClassesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.SCSID = new SelectList(db.ScheduledClassStatuses, "SCISD", "SCSName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ScheduledClassId,CourseId,StartDate,EndDate,InstuctorName,Location,SCSID")] ScheduledClass scheduledClass)
        {
            ...
            ViewBag.SCSID = new SelectList(db.ScheduledClassStatuses, "SCISD", "SCSName", scheduledClass.SCSID);
            return View(scheduledClass);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduledClassId,CourseId,StartDate,EndDate,InstuctorName,Location,SCSID")] ScheduledClass scheduledClass)
        {
            if (ModelState.IsValid)
            {
